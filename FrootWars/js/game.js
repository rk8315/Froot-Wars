...
var game = {
	...
	drawSlingshotBand:function(){
		...
		game.context.lineWidth = 6; // Draw at thick line

		// user angle hero has been dragged and radius to calculate coordinates of edge of hero wrt. hero center
	...
	stopBackgroundMusic:function(){
		...
		game.backgroundMusic.currentTime = 0; //  Go to the beginningof the song
	},
...
var levels = {
	...
	load:function(number) {
		...
		//Call game.start() once the assets have been loaded
		if(loader.loaded){
			game.start()
		} else {
